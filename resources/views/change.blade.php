	...
	<aside>
		...
		<div class="col-md-10 main-section">
			<section>
				...
				<div>
				<form action="{{url('changep')}}" method="post">
				{{csrf_field()}}
					<table class="addpage-table">
						...
						<tr>
							...
							<td>
								<input type="text" name="opassword" style="width:200px" value="{{isset($findrec[0]->categoryname) ? $findrec[0]->categoryname:""}}">
							</td>
						</tr>
                        <tr>
							<td style="width:250px; text-align:right">Enter New Password<span style="color:red">*</span></td>
							<td>
								<input type="text" name="npassword" style="width:200px" value="{{isset($findrec[0]->categoryname) ? $findrec[0]->categoryname:""}}">
							</td>
						</tr>
						<tr>
							<td style="width:250px; text-align:right">Confirm New Password<span style="color:red">*</span></td>
							<td>
								<input type="text" name="cpassword" style="width:200px" value="{{isset($findrec[0]->categoryname) ? $findrec[0]->categoryname:""}}">
							</td>
						</tr>
						<tr>
							<td colspan="2" >
