	...
	<div class="col-md-12" style="height:70%; min-height:200px">
		<div class="container">
			...
			<table class="table" style="width:150px; margin:40px auto">
				<tr>
					<td></td>
					<td style="color:#1C5978; font-weight:bold; text-align:center">Register</td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td><input type="submit" name="save" class="btn btn-sm btn-primary" style="margin-left:60px; padding:2px 15px"}></td>
				</tr>
			</table>
</form>
		</div>
