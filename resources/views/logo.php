		...
		<div class="container">
			<table class="table" style="width:150px; margin:40px auto">
				...
				<tr>
					...
					<td><input type="text" class="login-table-input" required></td>
				</tr>
				<tr style="border:none">
					<td class="login-table-text">Password</td>
					<td><input type="password" class="login-table-input" style="font-size:30px;height:25px" required></td>
				</tr>
				<tr>
					<td></td>
					<td><a href="index.html" class="btn btn-sm btn-primary" type="submit" style="margin-left:60px; padding:2px 15px"}>Login</a></td>
				</tr>
			</table>
		</div>
	</div>
